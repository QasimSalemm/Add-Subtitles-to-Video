...
st.markdown(
    ...
    <div class="section-card">
        ...
        <ul> 
            <li><b>Email:</b> 
                <a href="mailto:qasimsaleem317@gmail.com?subject=Support%20Request%20-%20Video%20Overlay%20Tool&body=Hello,%0D%0A%0D%0AI would like to ask about...">
            ...
            <li><b>Repository:</b> <a href="https://github.com/QasimSalemm/video-overlay-tool" target="_blank">Add Text to Video Tool Repo</a></li>
        </ul>
    </div>
    """,
